...
HOST_IPADDRESS=${1:-}
# IMAGE_SOURCE specifies the image source of the karmada component
# - build: build from source and then load into kind
# - local: skip build, just load local images into kind
# - pull: skip build and load, directly pull when in need

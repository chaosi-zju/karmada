...
func (in *ClusterMetric) DeepCopyInto(out *ClusterMetric) {
	*out = *in
	...
	if in.MissingPodRequestTotal != nil {
		in, out := &in.MissingPodRequestTotal, &out.MissingPodRequestTotal
		*out = new(int64)
		**out = **in
	}
	if in.RequestTotal != nil {
		in, out := &in.RequestTotal, &out.RequestTotal
		*out = new(int64)
		**out = **in
	}
	return
